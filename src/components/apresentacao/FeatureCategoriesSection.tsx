...
const FEATURE_CATEGORIES: FeatureCategory[] = [
  {
    ...
    title: 'Vendas & CRM',
    features: [
      { name: 'Pipeline Kanban', desc: 'Gestão visual de 8 estágios de leads', audience: ['construtora', 'imobiliaria'] },
      { name: 'Propostas Formais', desc: 'Documentos com validação e assinatura', audience: ['imobiliaria', 'corretor'] },
      { name: 'Fichas de Visita', desc: 'Registro com hash e geolocalização (validade jurídica)', audience: ['construtora', 'imobiliaria', 'corretor'] },
      { name: 'Agendamento Inteligente', desc: 'Calendário integrado com upload de documentos', audience: ['construtora', 'imobiliaria', 'cliente'] },
    ],
  },
  {
    icon: Palette,
    ...
    features: [
      { name: 'Sites White-Label', desc: 'Cada parceiro com sua marca automaticamente', audience: ['imobiliaria'] },
      { name: 'Templates Premium', desc: '4 estilos: Luxo, Moderno, Clássico, Alto Padrão', audience: ['construtora'] },
      { name: 'Domínio Personalizado', desc: 'URL própria para cada construtora', audience: ['construtora'] },
      { name: 'Aprovação de Mídias', desc: 'Workflow de controle de marca e materiais', audience: ['construtora', 'imobiliaria'] },
    ],
  },
  {
    icon: Bot,
    ...
    features: [
      { name: 'Sofia AI 24/7', desc: 'Chatbot com voz e base de conhecimento do imóvel', audience: ['construtora', 'cliente'] },
  ...
  },
  {
    ...
    title: 'Dados & Gestão',
    features: [
      { name: 'Feedback NPS', desc: 'Pesquisa pós-visita com assinatura digital', audience: ['construtora', 'imobiliaria'] },
      { name: 'Analytics BI', desc: 'Heatmap, funil, ROI e métricas por parceiro', audience: ['construtora', 'imobiliaria'] },
      { name: 'Multi-tenant', desc: 'Gestão separada construtora/imobiliária', audience: ['construtora', 'imobiliaria'] },
      { name: 'Hub de Integrações', desc: 'GA4, Pixel, webhooks e APIs externas', audience: ['construtora'] },
